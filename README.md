...
- `RESEND_SMTP_KEY`
- `RESEND_FROM_EMAIL`
- `RESEND_API_KEY` (booking email confirmations; can fallback to `RESEND_SMTP_KEY`)
- `TWILIO_ACCOUNT_SID` / `TWILIO_AUTH_TOKEN` / `TWILIO_FROM_NUMBER` (booking SMS)
- `BOOKING_REMINDER_CRON_SECRET` (optional protection for reminder dispatch endpoint)
